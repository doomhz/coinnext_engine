(function() {
  ...
  OrderBook = {
    findNextBuyOrder: function(transaction, callback) {
      ...
      return BuyOrder.find(orderToMatchQuery, {
    ...
    matchFirstOrder: function(callback) {
      ...
      return GLOBAL.db.sequelize.transaction(function(transaction) {
        return OrderBook.findNextBuyOrder(transaction, function(err, buyOrderToMatch) {
          if (err) {
            return err;
          }
          if (!buyOrderToMatch) {
