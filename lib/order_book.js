(function() {
  ...
  OrderBook = {
    ...
    calculateFee: function(amount) {
      return parseInt(math.ceil(math.select(MarketHelper.toBignum(amount)).divide(MarketHelper.toBignum(100)).multiply(MarketHelper.toBignum(MarketHelper.getTradeFee()))).done());
    },
